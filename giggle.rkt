...
(define (switch-module x y rotation label net-pos net-neg)
	`(module kbd:MX_ALPS_PG1350_noLed (layer F.Cu) (tedit 5B7FE0C4) (tstamp 5A91ACF7)
		(at ,x ,y ,rotation)
		(path /5A5E2B19)
		(fp_text reference ,label (at 4.6 6 ,rotation) (layer F.Fab) hide (effects (font (size 1 1) (thickness 0.15))))
		(fp_text value SW_PUSH (at 0.1 9.3 180) (layer F.Fab) hide (effects (font (size 1 1) (thickness 0.15))))
		(fp_line (start 10.525 10.525) (end 10.525 -10.525) (layer F.Fab) (width 0.15))
		(fp_line (start -10.525 10.525) (end 10.525 10.525) (layer F.Fab) (width 0.15))
		(fp_line (start -10.525 -10.525) (end -10.525 10.525) (layer F.Fab) (width 0.15))
		(fp_line (start 10.525 -10.525) (end -10.525 -10.525) (layer F.Fab) (width 0.15))
		...
		(fp_line (start 7 -7) (end 7 7) (layer Eco2.User) (width 0.15))
		(fp_line (start -7 -7) (end 7 -7) (layer Eco2.User) (width 0.15))
		(fp_line (start -9 9) (end -9 -9) (layer Eco2.User) (width 0.15))
		(fp_line (start 9 9) (end -9 9) (layer Eco2.User) (width 0.15))
		(fp_line (start 9 -9) (end 9 9) (layer Eco2.User) (width 0.15))
		(fp_line (start -9 -9) (end 9 -9) (layer Eco2.User) (width 0.15))
		(pad 0 np_thru_hole circle (at -5.08 0 180) (size 1.7 1.7) (drill 1.7) (layers *.Cu *.Mask F.SilkS))
		(pad 0 np_thru_hole circle (at -5.22 4.2 180) (size 1 1) (drill 1) (layers *.Cu *.Mask F.SilkS))
		(pad 0 np_thru_hole circle (at -5.5 0 270) (size 1.9 1.9) (drill 1.9) (layers *.Cu *.Mask F.SilkS))
		(pad 0 np_thru_hole circle (at 0 0 270) (size 4 4) (drill 4) (layers *.Cu *.Mask F.SilkS))
		(pad 0 np_thru_hole circle (at 5.08 0 180) (size 1.7 1.7) (drill 1.7) (layers *.Cu *.Mask F.SilkS))
		(pad 0 np_thru_hole circle (at 5.22 4.2 180) (size 1 1) (drill 1) (layers *.Cu *.Mask F.SilkS))
		(pad 0 np_thru_hole circle (at 5.5 0 270) (size 1.9 1.9) (drill 1.9) (layers *.Cu *.Mask F.SilkS))
		(pad 1 thru_hole circle (at -2.54 -4 180) (size 2.4 2.4) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-pos)
		(pad 1 thru_hole circle (at -2.54 -4.5 180) (size 2.4 2.4) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-pos)
		(pad 1 thru_hole circle (at -2.54 -5.08 180) (size 2.4 2.4) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-pos)
		(pad 1 thru_hole oval (at -3.81 -2.54 230) (size 2.8 1.55) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-pos)
		(pad 1 thru_hole oval (at -5.1 -3.9 230) (size 2.2 1.25) (drill 1.2) (layers *.Cu *.Mask F.SilkS) ,net-pos)
		(pad 1 thru_hole oval (at 5.1 -3.9 130) (size 2.2 1.25) (drill 1.2) (layers *.Cu *.Mask F.SilkS) ,net-pos)
		(pad 2 thru_hole circle (at 0 -5.9 270) (size 2.2 2.2) (drill 1.2) (layers *.Cu *.Mask F.SilkS) ,net-neg)
		(pad 2 thru_hole circle (at 2.54 -4 180) (size 2.4 2.4) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-neg)
		(pad 2 thru_hole circle (at 2.54 -4.5 180) (size 2.4 2.4) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-neg)
		(pad 2 thru_hole circle (at 2.54 -5.08 180) (size 2.4 2.4) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-neg)
		(pad 2 thru_hole oval (at 3.81 -2.54 130) (size 2.8 1.55) (drill 1.5) (layers *.Cu *.Mask F.SilkS) ,net-neg)
	)
)
